...
namespace haxe.lang
{
	public  class StringExt 
	{
		public    StringExt()
		{
			unchecked 
			{
				#line 26 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
				{
				}
...
namespace haxe.lang
{
	public  class StringRefl 
	{
		static StringRefl() 
		{
			#line 211 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
		...
		public    StringRefl()
		{
			unchecked 
			{
				#line 209 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
				{
				}
		...
		public static   object handleGetField(string str, string f, bool throwErrors)
		{
			unchecked 
			{
				...
				switch (f)
				{
					...
					default:
					{
						#line 220 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
						if (throwErrors) 
						{
							#line 222 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
						...
						{
							#line 224 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
		...
		public static   object handleCallField(string str, string f, global::Array args)
		{
			unchecked 
			{
				#line 230 "C:\\HaxeToolkit\\haxe/std/cs/internal/StringExt.hx"
