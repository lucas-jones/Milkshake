...
namespace haxe.io
{
	public  class BytesBuffer : global::haxe.lang.HxObject 
	{
		...
		public    BytesBuffer()
		{
			unchecked 
			{
				#line 42 "C:\\HaxeToolkit\\haxe/std/haxe/io/BytesBuffer.hx"
		...
		public virtual   global::haxe.io.Bytes getBytes()
		{
			unchecked 
			{
				#line 133 "C:\\HaxeToolkit\\haxe/std/haxe/io/BytesBuffer.hx"
				byte[] buf = this.b.GetBuffer();
				global::haxe.io.Bytes bytes = new global::haxe.io.Bytes(((int) (this.b.Length) ), ((byte[]) (buf) ));
				#line 141 "C:\\HaxeToolkit\\haxe/std/haxe/io/BytesBuffer.hx"
