...
class Key 
{
	...
	public static inline var UNDERSCORE:Int = 189;
	public static inline var PERIOD:Int = 190;
	public static inline var QUESTION_MARK:Int = 191;
	public static inline var TILDE:Int = 192;
	public static inline var OPEN_BRACKET:Int = 219;
	public static inline var BACKWARD_SLASH:Int = 220;
	public static inline var CLOSED_BRACKET:Int = 221;
	public static inline var QUOTES:Int = 222;
	...
	public static inline var SPACEBAR:Int = 32;
	...
	public static inline var MINUS:Int = 44;
